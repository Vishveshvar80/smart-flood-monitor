    ...
    <footer className="footer-panel">
      <div className="footer-container">
        <div className="footer-brand">
          ...
          <p>Electronics & Telecommunication Engineer | Software & AI Enthusiast</p>
        </div>

        <div className="footer-bottom">
          <p className="copyright">
            &copy; {currentYear} Vishveshvar Bidve. All rights reserved.
          </p>
          <div className="footer-links-actions">
            ...
            <a href="#" onClick={scrollToTop} className="back-to-top-btn" aria-label="Back to top">
              <ArrowUp size={16} />
            </a>
          </div>
        </div>
